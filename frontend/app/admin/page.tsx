    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link href="/admin/groups" className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 hover:border-gray-200 hover:shadow-md transition-all group">
            ...
            <h2 className="text-base font-bold text-gray-900 mb-1">Volunteer Groups</h2>
            <p className="text-sm text-gray-500">Create groups and manage membership for volunteers.</p>
          </Link>
